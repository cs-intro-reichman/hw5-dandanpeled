...
public class Scrabble {
	...
	public static int wordScore(String word) {
		...
		for (int i = 0; i < wordToCheck.length(); i++){
			char charToCheck = wordToCheck.charAt(i);
			int asciiNum = charToCheck;
	...
	public static String createHand() {
		...
		//Create the first 8 random char string
		randomCharString = MyString.randomStringOfLetters(HAND_SIZE-2);
